...
const sections: any = [{"type": "hero", "title": "Planos e Precos", "text": "Escolha o plano ideal para voce", "className": ""}, {"type": "pricing", "plans": [{"name": "Plano Básico", "price": "Sob consulta", "features": ["Plano Básico: Acesso simples com relatórios mensais"], "cta": "Contratar"}, {"name": "Plano Profissional", "price": "Sob consulta", "features": ["Plano Profissional: Gestão completa + integrações"], "cta": "Contratar"}, {"name": "Plano Enterprise", "price": "Sob consulta", "features": ["Plano Enterprise: Tudo do Profissional + suporte dedicado + SLA"], "cta": "Contratar"}], "className": ""}, {"type": "content", "paragraphs": ["Acessos VIP Clientes é uma empresa que oferece soluções de acesso e gestão de clientes.", "Gestão de acessos VIP", "Controle de entrada e saída", "Relatórios personalizados", "Integração com sistemas terceiros", "Suporte 24 horas", "Bem-vindo à Acessos VIP Clientes. Sua solução completa em gestão de acessos.", "Oferecemos tecnologia de ponta para controle de entrada e saída.", "Nossos sistemas são integrados com as principais plataformas do mercado.", "Mais de 500 empresas confiam na Acessos VIP Clientes.", "Suporte técnico especializado disponível 24 horas por dia.", "Transforme a gestão de acessos da sua empresa com a Acessos VIP Clientes.", "Solicite uma demonstração gratuita e descubra como podemos ajudar.", "Plano Básico: Acesso simples com relatórios mensais", "Plano Profissional: Gestão completa + integrações"], "className": ""}, {"type": "footer", "text": "(c) 2026 Acessos VIP Clientes. Todos os direitos reservados.", "className": ""}]
